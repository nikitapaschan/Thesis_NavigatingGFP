...
data_phacking_signal_ew5 <- sim_datasets_phacking(m = m, rho = rho, mhu = 5)
# save(data_phacking_signal_ew5, file='datasets/20240627_data_phacking_signal_ew5.RData')

datatable_phacking_ew5 <- as.data.table(data_phacking_signal_ew5$data_all)
unique(datatable_phacking_ew5$df)

# save(datatable_phacking_ew5, 'datasets/20240627_data_phacking_signal_ew5.RData')
# load('datasets/20240627_data_phacking_signal_ew5.RData')


# Use mclapply to process each row in parallel
datatable_phacking_ew5_pm <- do.call(rbind, pblapply(1:nrow(datatable_phacking_ew5_pm), function(i) process_row_mu(datatable_phacking_ew5_pm[i, ]), cl = detectCores() - 1))
head(datatable_phacking_ew5_pm)

datatable_phacking_ew5_pm <- merge(datatable_phacking_ew5_pm, datatable_phacking_ew5_pm, by = c('df', 'zo'))
head(datatable_phacking_ew5_pm)

# save(datatable_phacking_ew5_pm, file = '/Users/nikitapaschan/Master-Thesis/datasets/20240708_datatable_phacking_ew5_pm.Rdata')

# load('datasets/20240708_datatable_phacking_ew5_pm.Rdata')
...
datatable_phacking_ew5_pm <- merge(datatable_phacking_ew5, datatable_phacking_ew5_pm, by = c('df', 'zo'))
# save(datatable_phacking_ew5_pm, file='datasets/20240708_datatable_phacking_ew5_pm.Rdata')

# flags for magnitude of adjustment 
datatable_phacking_ew5_pm <- datatable_phacking_ew5_pm %>%
...
# save(datatable_phacking_ew5_pm, file='datasets/20240708_datatable_phacking_ew5_pm.Rdata')
# load('datasets/20240708_datatable_phacking_ew5_pm.Rdata')
str(datatable_phacking_ew5_pm)

# Check data
head(datatable_phacking_ew5_pm)
unique(datatable_phacking_ew5_pm$df)
hist(datatable_phacking_ew5_pm$diff_pm_po) 


######## Descriptive analysis ########
summary_datatable_phacking_ew5_pm <-  datatable_phacking_ew5_pm %>%
  group_by(df) %>%
...
head(summary_datatable_phacking_ew5_pm)
write_csv(summary_datatable_phacking_ew5_pm, file='datasets/20240702_summary_datatable_phacking_ew5_pm.csv')
           



### Plots ###
names(datatable_phacking_ew5_pm)[names(datatable_phacking_ew5_pm) == "param_m"] <- "m"
names(datatable_phacking_ew5_pm)[names(datatable_phacking_ew5_pm) == "param_rho"] <- "rho"
datatable_phacking_ew5_pm$threshold <- "5% alpha level"

## histogram of zo
hist_ew5_zo <-
  ggplot(datatable_phacking_ew5_pm, aes(x = zo)) +
...
# ggsave(
#   filename = "plots/plots_ew5/hist_ew5_zo.pdf",
#   plot = hist_ew5_zo, 
#   width = 10,        
#   height = 8,        
#   units = "in"      
...
## histogram of zr
hist_ew5_zr <-
  ggplot(datatable_phacking_ew5_pm, aes(x = zr)) +
  geom_histogram(binwidth = 0.3, fill = "blue", color = "black") +
  geom_vline(aes(xintercept = 1.96, color = "5% alpha level"), linetype = "dashed") +
  geom_vline(aes(xintercept = -1.96, color = "5% alpha level"), linetype = "dashed") +
  labs(
...
# ggsave(
#   filename = "plots/plots_ew5/hist_ew5_zr.pdf",
#   plot = hist_ew5_zr, 
#   width = 10,        
#   height = 8,        
#   units = "in"      
...
boxplot_rho_po_ew5 <-
  ggplot(datatable_phacking_ew5_pm, aes(x = as.factor(rho), y = po)) +
  geom_boxplot() +
  labs(
...
# ggsave(
#   filename = "plots/plots_ew5/boxplot_rho_po_ew5.pdf",
#   plot = boxplot_rho_po_ew5, 
#   width = 10,       
#   height = 8,       
#   units = "in"       
# )
...
boxplot_rho_pr_ew5 <-
  ggplot(datatable_phacking_ew5_pm, aes(x = as.factor(rho), y = pr)) +
  geom_boxplot() +
  labs(
...
# ggsave(
#   filename = "plots/plots_ew5/boxplot_rho_pr_ew5.pdf",
#   plot = boxplot_rho_pr_ew5, 
#   width = 10,       
#   height = 8,       
#   units = "in"       
# )
...
### boxplot pm 
boxplot_rho_pm_ew5 <-
  ggplot(datatable_phacking_ew5_pm, aes(x = as.factor(rho), y = pm)) +
  geom_boxplot() +
  labs(
...
# ggsave(
#   filename = "plots/plots_ew5/boxplot_rho_pm_ew5.pdf",
#   plot = boxplot_rho_pm_ew5, 
#   width = 10,       
#   height = 8,       
#   units = "in"       
# )
...
phacking_popr <- ggplot(datatable_phacking_ew5_pm, aes(x = po, y = pr, color = factor(p_hacking_5p))) +
  geom_point() +
...
# Save the plot
# ggsave(
#   filename = "plots/plots_ew5/phacking_popr.pdf",
#   plot = phacking_popr, 
#   width = 10,        
#   height = 8,        
#   units = "in"      
...
sum(datatable_phacking_ew5_pm$po < 0.05 & datatable_phacking_ew5_pm$pr < 0.05) / nrow(datatable_phacking_ew5_pm)
sum(datatable_phacking_ew5_pm$po > 0.05 & datatable_phacking_ew5_pm$pr < 0.05) / nrow(datatable_phacking_ew5_pm)
sum(datatable_phacking_ew5_pm$po > 0.05 & datatable_phacking_ew5_pm$pr > 0.05) / nrow(datatable_phacking_ew5_pm)
sum(datatable_phacking_ew5_pm$po < 0.05 & datatable_phacking_ew5_pm$pr > 0.05) / nrow(datatable_phacking_ew5_pm)

plausibility_pmpo_ew5 <- ggplot(datatable_phacking_ew5_pm, aes(x = pm, y = po, color = factor(nonsig_5p_pm))) +
  geom_point() +
  facet_grid(rho ~ m, labeller = label_both) +  
...
plausibility_pmpo_ew5

# ggsave(
#   filename = "plots/plots_ew5/plausibility_pmpo_ew5.pdf",
#   plot = plausibility_pmpo_ew5, 
#   width = 10,        
#   height = 8,        
#   units = "in"      
# )
...
magnitude_pmpo_ew5 <- ggplot(datatable_phacking_ew5_pm, aes(x = rho, y = avg_diff_pmpo, color = factor(m))) +
  ...
  scale_x_continuous(breaks = unique(summary_datatable_phacking_ew5_pm$rho)) +
  theme_bw() +
  theme(
...
# ggsave(
#   filename = "plots/plots_ew5/magnitude_pmpo_ew5.pdf",
#   plot = magnitude_pmpo, 
#   width = 10,        
#   height = 8,        
#   units = "in"      
...
for (param_m in unique(datatable_phacking_ew5_pm$param_m)) {
  for (param_rho in unique(datatable_phacking_ew5_pm$param_rho)) {
    subset_data <- datatable_phacking_ew5_pm %>%
    ...
    power_results_ew5 <- rbind(power_results_ew5, data.frame(
      param_m = param_m,
      param_rho = param_rho,
...
head(power_results_ew5)

# Plot power curves for different adjustment methods
power_curve_plot_ew5 <-ggplot(power_results_ew5, aes(x = param_rho)) +
...
# Print the plot
power_curve_plot_ew5

# Save the plot as a PDF file
# ggsave(
#   filename = "plots/plots_ew5//power_curve_ew5.pdf",
#   plot = power_curve_plot_ew5, 
#   width = 10,        
#   height = 8,        
#   units = "in"       
# )
