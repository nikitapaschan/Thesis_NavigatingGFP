...
save(result_testing, file = "datasets/data_sim_rdf/rdf_alternative_tests.RData")
## MaxZ test results
# create new data set
...
# adjusted p-value: 
m_testing <- 3
min_rho_testing <- min(cor_testing)
...
table(phacked_testing$sig_flg_testing, phacked_testing$sig_flg_pm_maxr) 
